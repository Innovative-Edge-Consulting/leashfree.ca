...
function updateCitiesJson() {
  ...
  const intro = "<p>Gimli's municipal source picture is narrower than the generic city page implied. The reviewed Rural Municipality of Gimli pages clearly publish animal-control, leash, and beach-access rules, but they do not currently provide a strong dedicated municipal fact page for an official off-leash dog park. That means this guide should prioritize what the municipality clearly states over unverified amenity claims.</p>";
  const about = "<p>The reviewed RM of Gimli source set is strongest on rules and public-space boundaries. The municipality's FAQ says all dogs must be leashed when off the owner's property and are not permitted to run at large. The same FAQ also says dogs are not allowed on any public beach in the municipality, though they are permitted on the boardwalk and grass areas as long as they are leashed and owners clean up after them. The municipality's Animal Control page adds that enforcement is regulated by Animal Control By-law #20-0003 and provides direct contact information for the Animal Control Officer.</p><p>What the municipality does publish clearly is the broader recreation setting around dog outings. Gimli's parks and beach pages position the community as a Lake Winnipeg destination with beaches, grassy parks, a boardwalk, harbour spaces, and a recreation centre at 45 Centennial Road. That matters because it tells dog owners where leashed outings fit into the public landscape even when the municipality is not publishing a full dog-park amenities sheet. As of Tuesday, July 28, 2026, the safest high-trust approach for this city page is to describe Gimli as a municipality with clear leash and beach restrictions and to tell owners to verify any claimed off-leash enclosure directly with the RM before relying on third-party listings.</p>";
  ...
  const faqs = "<p><strong>1. Can I walk my dog off leash in Gimli?</strong></p><p>No. The RM of Gimli FAQ says all dogs must be leashed when off the owner's property and are not allowed to run at large.</p><p><strong>2. Are dogs allowed on Gimli's public beaches?</strong></p><p>No. The municipality says dogs are not allowed on any public beach.</p><p><strong>3. Where can dogs go in public near the waterfront?</strong></p><p>The RM says dogs are permitted on the boardwalk and grass areas if they are leashed and cleaned up after.</p><p><strong>4. What bylaw governs animal control in Gimli?</strong></p><p>The municipality says animal control is regulated by By-law #20-0003.</p><p><strong>5. Does the RM currently publish a strong official dog-park page?</strong></p><p>Not in the reviewed municipal source set. As of Tuesday, July 28, 2026, the strongest published material is the leash, beach, and animal-control guidance, so owners should verify any off-leash enclosure details directly with the RM.</p><p><strong>6. Who should I contact if I need to confirm current dog rules?</strong></p><p>The municipality's Animal Control page lists the Animal Control Officer at 204-642-4775.</p>";
  ...
  setRawFields(city.raw, {
    ...
    "Dog Park FAQs": faqs,
    "Nearby Cities": "",
    "Updated On": "Tue Jul 28 2026 17:15:00 GMT+0000 (Coordinated Universal Time)",
    "Reviewed On": "Tue Jul 28 2026 17:15:00 GMT+0000 (Coordinated Universal Time)"
  });
...
function updateCityCsv() {
  ...
  const updates = {
    ...
    "Hero Image": "",
    "Intro Paragraph": "<p>Gimli's municipal source picture is narrower than the generic city page implied. The reviewed Rural Municipality of Gimli pages clearly publish animal-control, leash, and beach-access rules, but they do not currently provide a strong dedicated municipal fact page for an official off-leash dog park. That means this guide should prioritize what the municipality clearly states over unverified amenity claims.</p>",
