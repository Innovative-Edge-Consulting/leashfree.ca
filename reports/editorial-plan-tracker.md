...
| 13 | Backlog | 18 | Wildfire Smoke and Dogs in Canada: When To Skip the Walk | `wildfire-smoke-dogs-canada` | Seasonal safety | Dog parks, vet directory | AQHI, wildfire smoke, veterinary respiratory guidance | Confirm AQHI/action thresholds | Timely during smoke events. |
